...
export const DASHBOARD_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'products/new', loadComponent: () => import('../products/product-form/product-form').then(m => m.ProductForm) },
      ...
      { path: 'purchases', loadComponent: () => import('../purchases/purchase-list/purchase-list').then(m => m.PurchaseList) },
      { path: 'purchases/new', loadComponent: () => import('../purchases/purchase-form/purchase-form').then(m => m.PurchaseForm) },
      ...
      { path: 'suppliers/new', loadComponent: () => import('../suppliers/supplier-form/supplier-form').then(m => m.SupplierForm) },
      { path: 'suppliers/:id/edit', loadComponent: () => import('../suppliers/supplier-form/supplier-form').then(m => m.SupplierForm) },
